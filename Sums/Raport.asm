...
start:
    ...
    call CloseFile ;Zamykam plik wejsciowy  
...
Parser proc
    ...
    jne @@second_parameter
        ;jezeli znalezlismy sie wewnątrz znaczy że nie znaleźlismy drugiego argumentu
        mov AX, seg ERROR2
        mov DS, AX
        mov DX, offset ERROR2
        mov AH, byte ptr 9 ;Wypisuje informacje o bledzie
    ...
    je @@end_of_input
        ;jezeli znalezlismy sie wewnątrz, znaczy ze mamy za duzo argumentow
        mov AX, seg ERROR3
        mov DS, AX
...
push DX
  ...
  xor AX, AX
  mov AX, 0 ;Przechodze cala tablice RES_TABLE
  GenerateBuffer_loop:
  push AX
